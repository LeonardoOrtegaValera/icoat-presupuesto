      ...
      <header className="no-print" style={{ background: C.primary, color: 'white', padding: '20px 24px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <div style={{ fontSize: 20, fontWeight: 800, lineHeight: 1.1 }}>ICOAT GROUP</div>
              <div style={{ fontSize: 12, opacity: 0.85 }}>Sistema de Presupuestos · Pisos Epóxicos</div>
            </div>
          </div>
      ...
      <div style={{ background: C.primary, color: 'white', padding: '32px 40px', position: 'relative' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{ width: 64, height: 64, background: C.accent, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 24, color: C.primary }}>
              IG
            </div>
            <div>
              <div style={{ fontSize: 28, fontWeight: 900, letterSpacing: -0.5 }}>ICOAT GROUP</div>
